...
class ArtProvider extends Component {
    ...
    getData = async () => {
        try {
            ...
            let stories = this.formatStoriesData(data);
            ...
            let museum = stories.filter(
                museum => museum.contentType === 'museum'
            );
  ...
  */
    ...
    getStoriesPerMuseum = slug => {
        ...
        let filteredLocation = tempLocation
            .flat()
            .filter(item => item.museumSlug === slug);
    ...
    render() {
        return this.state.loading ? (
            ...
            <ArtContext.Provider
                value={{
                    ...this.state,
                    getStoriesDetails: this.getStoriesDetails,
                    getStoriesPerMuseum: this.getStoriesPerMuseum
                }}>
                {this.props.children}
            </ArtContext.Provider>
        );
